      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-text-secondary text-sm mb-6">
              Your trusted companion for discovering the best of Koh Samui.
              From hidden beaches to investment opportunities, we've got you covered.
            </p>
            {/* Social Links */}
            ...
            <ul className="space-y-2">
              {footerLinks.explore.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-text-secondary hover:text-primary-600 text-sm transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-sm text-text-secondary">
            © {currentYear} Samui Insider Guide. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
